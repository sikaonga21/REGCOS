    ...
    <section className="py-20 bg-[#F3F5F8]">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {/* Vision */}
          <motion.div
            className="bg-[#063B82] p-12 text-white"
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <div className="w-12 h-12 bg-white/10 flex items-center justify-center mb-8">
              <Eye size={24} weight="fill" className="text-[#FFD400]" />
            </div>
            ...
            <div className="w-10 h-0.5 bg-[#FFD400] mb-6" />
          ...
          <motion.div
            ...
            viewport={{ once: true, margin: '-80px' }}
          >
            <div className="w-12 h-12 bg-[#063B82] flex items-center justify-center mb-8">
              <Compass size={24} weight="fill" className="text-white" />
            </div>
            <p className="text-[#063B82]/50 font-bold text-xs uppercase tracking-[0.3em] mb-4">
              Our Mission
            </p>
            <h3 className="text-2xl font-bold text-[#063B82] uppercase mb-6 leading-tight">
